    ...
    <div>
      <section className="bg-gradient-to-r from-accent/10 to-secondary/10 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold text-gray-900 mb-2">Celulares</h1>
          <p className="text-lg text-gray-600">Descubre la gama mas avanzada de smartphones. Potencia, camara y diseno.</p>
        </div>
      </section>
