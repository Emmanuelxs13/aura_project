    ...
    <div>
      <section className="bg-gradient-to-br from-gray-800 to-gray-900 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-black text-white mb-2">Laptops</h1>
          <p className="text-gray-300 text-lg max-w-xl">Potencia y portabilidad. Workstations para profesionales exigentes.</p>
        </div>
      </section>
